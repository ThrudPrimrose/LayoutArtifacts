...
#SBATCH --job-name="aos_gemm_m4096_n4096_k4096"
#SBATCH --time=18:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --partition=mi300
#SBATCH --output=aos_gemm_m4096_n4096_k4096.%j.o
#SBATCH --error=aos_gemm_m4096_n4096_k4096.%j.e
...
/capstor/scratch/cscs/ybudanaz/beverinenv/bin/python complex_gemm.py --layout AoS --m 4096 --n 4096 --k 4096 
