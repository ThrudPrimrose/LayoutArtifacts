...
#SBATCH --job-name="aos_gemm_m2048_n16384_k16384"
#SBATCH --time=18:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --partition=mi300
#SBATCH --output=aos_gemm_m2048_n16384_k16384.%j.o
#SBATCH --error=aos_gemm_m2048_n16384_k16384.%j.e
...
/capstor/scratch/cscs/ybudanaz/beverinenv/bin/python complex_gemm.py --layout AoS --m 2048 --n 16384 --k 16384 
