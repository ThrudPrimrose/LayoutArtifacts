...
/capstor/scratch/cscs/ybudanaz/spack/opt/spack/linux-sles15-zen3/gcc-12.3.0/rocthrust-6.2.1-ihyylrpt7zc2buckjcgkaxlmll3kib4u/include/thrust/complex.h:402:3: error: function cannot return function type 'int (int)'
  402 |   T real() const volatile { return data.x; }
      |   ^
/capstor/scratch/cscs/ybudanaz/LayoutArtifacts/ComplexGEMM/.dacecache/complex_gemm_aos_AoS_16384_16384_16384/src/cuda/hip/complex_gemm_aos_AoS_16384_16384_16384_cuda.cpp:110:48: note: in instantiation of template class 'thrust::complex<int (int)>' requested here
