...
#SBATCH --job-name="gpu_usu_atile1"
#SBATCH --time=12:00:00
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --partition=mi300
#SBATCH --output=gpu_usu_atile1.%j.o
#SBATCH --error=gpu_usu_atile1.%j.e
#SBATCH --mem=256GB
...
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile.py 1026
...
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile_transposed.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile_transposed.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile_transposed.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile_transposed.py 1026
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_auto_tile_transposed.py 1026
