...
if __name__ == "__main__":
    ...
    for _N in N_values:
        ...
        if t:
            tsdfg.name = f"cpu_usu_transposed_{_N}"
            tuned_sdfg = autotune(tsdfg, {"vals_A": vals_A, "vals_B": vals_B, "neighbors": neighbors, "TSTEPS": 10, "N": _N}, 3, [_N, _N, _N])
        else:
            sdfg.name = f"cpu_usu_{_N}"
