...
#SBATCH --job-name="gpu_usu_big1"
#SBATCH --time=12:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=4
#SBATCH --partition=mi300
#SBATCH --output=gpu_usu_big1.%j.o
#SBATCH --error=gpu_usu_big1.%j.e
#SBATCH --mem=256GB
...
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_v2.py 130 258
}' &

export CUDA_VISIBLE_DEVICES=1; srun -n 1 -o output.%J.v3.log --exact bash -c ' {
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_v2.py 1026
}' &

export CUDA_VISIBLE_DEVICES=2; srun -n 1 -o output.%J.v3.log --exact bash -c ' {
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_v2.py 1282
}' &

export CUDA_VISIBLE_DEVICES=3; srun -n 1 -o output.%J.v3.log --exact bash -c ' {
/capstor/scratch/cscs/ybudanaz/.def/bin/python unstructured_stencil_3d_u_s_u_v2_dace_v2.py  514
}' &
