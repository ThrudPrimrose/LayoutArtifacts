...
if __name__ == "__main__":
    ...
    for _N in N_values:
        ...
        for _TSTEPS in [50, 1000]:
            #if Path(f"gpu_u_s_u_times_N_{_N}_TSTEPS_{_TSTEPS}_auto_tile.txt").exists():
            #    continue
            with open(f"gpu_u_s_u_times_N_{_N}_TSTEPS_{_TSTEPS}_auto_tile.txt", "w") as f:
