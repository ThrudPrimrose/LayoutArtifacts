...
outerLoopKernel_1_2_0(float *__restrict__ shrA, float *__restrict__ shrB,
                      float *__restrict__ tmp, int K, int M, int N,
                      long long b_i, long long b_j, long long d_i,
                      long long d_j, long long k)
{
...
nested_sub_0_0_12(float *__restrict__ shrA, float *__restrict__ shrB,
                  float *__restrict__ tmp, int K, int M, int N, long long b_i,
                  long long b_j, long long d_i, long long d_j, long long k)
{
...
remainderAssignment1_4_2_0(float *__restrict__ tmp, float *__restrict__ C,
                           int M, int N, long long b_i, long long b_j,
                           long long d_i, long long d_j)
{
...
nestedAssignment1_0_0_13(float *__restrict__ tmp, float *__restrict__ C, int M,
                         int N, long long b_i, long long b_j, long long d_i,
                         long long d_j)
{
...
#pragma unroll
                    ...
                    __syncthreads();
                    nested_sub_0_0_12(&shrA[(16 * d_i)], &shrB[d_j], &tmp[0], K,
                                      M, N, b_i, b_j, d_i, d_j, k);
                    __syncthreads();
                  }
                }
                nestedAssignment1_0_0_13(&tmp[0],
                                         &C[(((N * (b_i + d_i)) + b_j) + d_j)],
                                         M, N, b_i, b_j, d_i, d_j);
              }
            }
