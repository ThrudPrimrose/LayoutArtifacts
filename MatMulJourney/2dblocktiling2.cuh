...
__global__ void _2d_block_tiling2(const float *__restrict__ A, const float *__restrict__ B, float *__restrict__ C,
...
void _2d_block_tiling_launcher2(const float *__restrict__ A,
